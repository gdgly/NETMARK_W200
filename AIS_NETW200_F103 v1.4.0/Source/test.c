...
void ProgramSelector(void) //拨码器程序选择
{
	...
	else if( (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11) == 0) && (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15) == 0) )
	{
		CurrentTest();
	}
	else if( (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11) == 0) && (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15) == 1) )
	{
		EjectTest();
	}
}
...
void CurrentTest(void) //电老化测试程序
{
	...
	while(1)
	{
		...
		if( (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11) != 0) || (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15) != 0) )
		{
			break;
		}
...
void EjectTest(void)  //发射测试程序
{
	...
	while(1)
	{
		if( (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_11) != 0) || (GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_15) != 1) )
		{
			break;
		}
